...
<h1>Автор: <?= $posts[0]['AUTHOR_NAME'] ?> <?= $posts[0]['AUTHOR_LASTNAME'] ?></h1>

<?php foreach ($posts as $post) { ?>
    <div style="margin-bottom:30px">
        <h4><a href="/local/blog/post.php?id=<?= $post['ID'] ?>"><?= $post['UF_HEADING'] ?></a></h4>
        <h6><?= $post['AUTHOR_NAME'] ?> <?= $post['AUTHOR_LASTNAME'] ?></h6>
        <h6>
...
<p>
    <a href="/local/blog/editor.php?id=<?= $posts[0]['AUTHOR_ID'] ?>">Редактировать статьи &rarr;</a>
</p>
